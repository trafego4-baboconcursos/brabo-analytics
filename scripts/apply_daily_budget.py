#!/usr/bin/env python3
"""
Aplica o orcamento diario (Facebook + Google) das campanhas de captacao do PBB-AGO-26,
lendo o valor do dia em performance-manager/PBB-AGO-26/orcamento_diario.json.

Uso:
    python scripts/apply_daily_budget.py                # aplica o orcamento de hoje
    python scripts/apply_daily_budget.py --date 2026-08-10  # aplica um dia especifico (teste/reprocesso)
...
PLAN_PATH = os.path.join(ROOT, "performance-manager", "PBB-AGO-26", "orcamento_diario.json")

load_dotenv(os.path.join(ROOT, ".env"))

META_ACCOUNT_ID = "act_438212624024216"
GOOGLE_CUSTOMER_ID = "1450466453"
...
def main():
    ...
    print(f"=== Aplicando orcamento PBB-AGO-26 para {date_str} ===")
