...
df_facebook = pd.read_csv(r'analises/[PBB-ABR-26]/ANALISE_FACEBOOK_[PBB-ABR-26].csv')
df_youtube = pd.read_csv(r'analises/[PBB-ABR-26]/ANALISE_YOUTUBE_[PBB-ABR-26].csv')
df_consolidada = pd.read_csv(r'analises/[PBB-ABR-26]/ANALISE_CONSOLIDADA_[PBB-ABR-26].csv')
...
with open(r'analises/[PBB-ABR-26]/ANALISE_FACEBOOK_[PBB-ABR-26].html', 'w', encoding='utf-8') as f:
    f.write(html_facebook)
print("   ✓ ANALISE_FACEBOOK_[PBB-ABR-26].html")

with open(r'analises/[PBB-ABR-26]/ANALISE_YOUTUBE_[PBB-ABR-26].html', 'w', encoding='utf-8') as f:
    f.write(html_youtube)
print("   ✓ ANALISE_YOUTUBE_[PBB-ABR-26].html")

with open(r'analises/[PBB-ABR-26]/ANALISE_CONSOLIDADA_[PBB-ABR-26].html', 'w', encoding='utf-8') as f:
