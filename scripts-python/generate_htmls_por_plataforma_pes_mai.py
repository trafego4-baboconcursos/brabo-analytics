...
# -*- coding: utf-8 -*-
"""
Gerador de HTMLs por Plataforma - PES-MAI-26
Gera 3 relatórios HTML:
1. ANALISE_FACEBOOK_[PES-MAI-26].html
2. ANALISE_YOUTUBE_[PES-MAI-26].html
3. ANALISE_CONSOLIDADA_[PES-MAI-26].html

Lê os CSVs gerados por generate_analises_por_plataforma_pes_mai.py
"""
...
def gerar_html_plataforma(nome_plataforma, df_dados, cor_primaria, cor_secundaria):
    """Gera HTML para uma plataforma específica — PES-MAI-26"""
...
<head>
    ...
    <title>Análise {nome_plataforma} - PES-MAI-26</title>
...
<body>
    <div class="container">
        <div class="header">
            <div class="header-logo"><a href="INDEX_[PES-MAI-26].html"><img src="../../img/logo-brabo-concursos.png" alt="Brabo Concursos"></a></div>
            <div>
                <h1>📊 Análise {nome_plataforma}</h1>
                <div class="subtitle">Campanha: PES-MAI-26 | Período: Abril-Maio 2026</div>
...
# ========== GERAR OS 3 HTMLs ==========
print("\n" + "=" * 100)
print("GERADOR DE HTMLs POR PLATAFORMA - PES-MAI-26")
print("=" * 100)
