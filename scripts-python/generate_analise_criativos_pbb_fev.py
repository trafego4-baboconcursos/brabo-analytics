#!/usr/bin/env python3
# -*- coding: utf-8 -*-
"""Wrapper fixo para gerar a analise de criativos do PBB-FEV-26."""
...
def parse_args() -> argparse.Namespace:
    parser = argparse.ArgumentParser(description="Wrapper fixo da analise de criativos PBB-FEV-26")
    parser.add_argument(
        "--output-filename",
        help="Nome opcional do arquivo HTML de saida dentro de analises/[PBB-FEV-26]/",
    )
