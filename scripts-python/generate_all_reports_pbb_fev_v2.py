...
# Carregar Meta Ads
try:
    df_meta = pd.read_csv(META_ADS_PATH / "meta-pbb-fev-26.csv", encoding='utf-8')
...
try:
    ...
    if not leads_candidates:
        active_campaign_alt = ANALISES_PATH / "active-campaing"
    ...
    if not leads_candidates:
        leads_candidates.extend(
            ...
            if "lead" in f.name.lower() or "pbb-fev-26" in f.name.lower() or "banco do brasil" in f.name.lower()
        )
...
try:
    df_tmb = pd.read_csv(VENDAS_PATH / 'tmb pbb-fev-26.csv', sep=';', encoding='latin-1')
    _col_situacao = next((c for c in df_tmb.columns if 'situa' in c.lower() or 'status' in c.lower()), None)
    if _col_situacao:
        _status_validos = {'vigente', 'efetivado'}
        df_tmb = df_tmb[df_tmb[_col_situacao].astype(str).str.strip().str.lower().isin(_status_validos)]
    _col_email_tmb = (
        encontrar_coluna(df_tmb, ['cliente', 'email']) or
        next((c for c in df_tmb.columns if 'mail' in c.lower() or 'email' in c.lower()), None)
    )
    _col_ticket_tmb = next((c for c in df_tmb.columns if 'ticket' in c.lower()), None)
    if _col_email_tmb is None or _col_ticket_tmb is None:
        raise KeyError(f"Colunas de email/ticket não encontradas no TMB: {list(df_tmb.columns)}")
    df_tmb['email'] = df_tmb[_col_email_tmb].astype(str).str.strip().str.lower()
    df_tmb['valor_num'] = df_tmb[_col_ticket_tmb].apply(limpar_numero)
...
# 1. INDEX
print("\n📄 [1/8] Gerando INDEX_[PBB-FEV-26].html...")
    ...
    <div class="container">
        ...
        <div class="content">
            ...
            <div class="grid">
                ...
                <div class="card">
                    <h3>📢 Google Anúncios</h3>
                    <p>Leitura detalhada da camada criativa do Google, com foco em anúncios, cliques e eficiência.</p>
                    <a href="ANALISE_GOOGLE_ANUNCIOS_[PBB-FEV-26].html" style="color: #667eea; text-decoration: none; font-weight: bold;">Ver Análise →</a>
                </div>
                ...
                <div class="card">
                    ...
                    <a href="ANALISE_TYPEFORM_[PBB-FEV-26].html" style="color: #667eea; text-decoration: none; font-weight: bold;">Ver Análise →</a>
                </div>
                ...
                <div class="card">
                    <h3>💰 Vendas</h3>
                    <p>Fechamento comercial com vendas totais, faturamento, origem e validação dos dados transacionais.</p>
                    <a href="ANALISE_VENDAS_[PBB-FEV-26].html" style="color: #667eea; text-decoration: none; font-weight: bold;">Ver Análise →</a>
                </div>
                
                <div class="card">
                    <h3>📘 Facebook — Performance</h3>
                    <p>Análise detalhada por campanha, conjunto e criativo do Facebook Ads.</p>
                    <a href="ANALISE_FACEBOOK_[PBB-FEV-26].html" style="color: #667eea; text-decoration: none; font-weight: bold;">Ver Análise →</a>
                </div>
                
                <div class="card">
                    <h3>▶️ YouTube — Performance</h3>
                    <p>Análise de campanhas de vídeo e tráfego do YouTube Ads.</p>
                    <a href="ANALISE_YOUTUBE_[PBB-FEV-26].html" style="color: #667eea; text-decoration: none; font-weight: bold;">Ver Análise →</a>
                </div>
                
                <div class="card">
                    <h3>📊 Consolidado Multi-plataforma</h3>
                    <p>Visão unificada de Facebook e YouTube com comparativo lado a lado.</p>
                    <a href="ANALISE_CONSOLIDADA_[PBB-FEV-26].html" style="color: #667eea; text-decoration: none; font-weight: bold;">Ver Análise →</a>
                </div>
            </div>
...
# 2. META ADS
print("\n📄 [2/8] Gerando ANALISE_META_ADS_[PBB-FEV-26].html...")
    ...
    <div class="container">
        ...
        <div class="content">
            ...
            <div class="recommendation-box">
                ...
                Ver também: <a href="ANALISE_META_AUDIENCES_[PBB-FEV-26].html" style="color:#856404">ANALISE_META_AUDIENCES →</a>
                | <a href="ANALISE_ANUNCIOS_[PBB-FEV-26].html" style="color:#856404">ANALISE_ANUNCIOS →</a>
            </div>
            <div class="success-box">
...
print("\n📄 [3/8] Gerando ANALISE_GOOGLE_ADS_[PBB-FEV-26].html...")
    ...
    <div class="container">
        ...
        <div class="content">
            ...
            <div class="success-box">
                ...
                Consulte os dados brutos em <code>Performance dos anúncios-pbb-fev-26.csv</code>.
            </div>
            <div class="recommendation-box">
                <strong>💡 Ação recomendada</strong><br>
                Compare CPA do Google Ads com o CPA do Meta Ads para orientar realocação de budget entre plataformas.
                Ver também: <a href="ANALISE_GOOGLE_AUDIENCES_[PBB-FEV-26].html" style="color:#856404">ANALISE_GOOGLE_AUDIENCES →</a>
            </div>
...
print("\n📄 [4/8] Gerando ANALISE_LEADS_CONFRONTO_[PBB-FEV-26].html...")
...
# 5. ANUNCIOS
print("\n📄 [5/8] Gerando ANALISE_ANUNCIOS_[PBB-FEV-26].html...")
_cwd_original = Path.cwd()
try:
    os.chdir(BASE_PATH)
    runpy.run_path(str(BASE_PATH / "scripts-python" / "generate_analise_anuncios_fev_final.py"), run_name="__main__")
finally:
...
print("\n📄 [6/8] Gerando ANALISE_META_AUDIENCES_[PBB-FEV-26].html...")
    ...
    <div class="container">
        ...
        <div class="content">
            ...
            <div class="recommendation-box">
                ...
                Combine com a análise de criativos: <a href="ANALISE_ANUNCIOS_[PBB-FEV-26].html" style="color:#856404">ANALISE_ANUNCIOS →</a>
            </div>
...
print("\n📄 [7/8] Gerando ANALISE_GOOGLE_AUDIENCES_[PBB-FEV-26].html...")
    ...
    <div class="container">
        ...
        <div class="content">
            ...
            <div class="recommendation-box">
                ...
                Combine com a análise criativa do canal: <a href="ANALISE_GOOGLE_ANUNCIOS_[PBB-FEV-26].html" style="color:#856404">ANALISE_GOOGLE_ANUNCIOS →</a>
            </div>
...
print("\n📄 Gerando ANALISE_VENDAS_[PBB-FEV-26].html...")
_cwd_original = Path.cwd()
try:
    os.chdir(BASE_PATH)
    runpy.run_path(str(BASE_PATH / "scripts-python" / "generate_analise_vendas_final.py"), run_name="__main__")
finally:
    os.chdir(_cwd_original)
print("✓ Vendas análise criada")

# 8. INSIGHTS - com dados reais das plataformas
print("\n📄 [8/8] Gerando INSIGHTS_RECOMENDACOES_[PBB-FEV-26].html...")
    ...
    <div class="container">
        ...
        <div class="content">
            ...
            <div class="recommendation-box">
                ...
                <br><a href="ANALISE_ANUNCIOS_[PBB-FEV-26].html" style="color:#856404">→ Ver Análise de Anúncios</a>
            </div>
            <div class="recommendation-box">
                ...
                <br><a href="ANALISE_META_AUDIENCES_[PBB-FEV-26].html" style="color:#856404">→ Ver Públicos Meta</a> |
                <a href="ANALISE_GOOGLE_ADS_[PBB-FEV-26].html" style="color:#856404">→ Ver Google Ads</a>
            </div>
            <div class="recommendation-box">
                ...
                <br><a href="ANALISE_LEADS_CONFRONTO_[PBB-FEV-26].html" style="color:#856404">→ Ver Confronto de Leads</a>
            </div>
            <div class="recommendation-box">
                ...
                <br><a href="ANALISE_GOOGLE_AUDIENCES_[PBB-FEV-26].html" style="color:#856404">→ Ver Públicos Google</a>
            </div>
            <div class="success-box">
                <strong>✅ Fontes de dados utilizadas</strong><br>
                Meta Ads: <code>MA-Campanhas-Completas-PBB-FEV-26.csv</code> ({len(df_meta) if df_meta is not None else 0:,} linhas) |
                Google Ads Campanhas: <code>Performance da campanha-pbb-fev-26.csv</code> ({len(df_ga_campanhas) if df_ga_campanhas is not None else 0:,} linhas) |
                CRM: <code>active-campaing</code> ({_ins_total_leads_crm:,} leads)
            </div>
