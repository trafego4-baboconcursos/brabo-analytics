...
from frontend.db_readers import (
    ...
    read_launch_config, save_launch_config, ConfigInvalida, create_launch, count_campaigns_for_filter, get_drive_thumbnails,
    ...
    if is_admin_or_analista:
        groups.append({
            ...
            "links": [
                ...
                {"page": "pesquisas", "label": "Pesquisas", "icon": "ti-clipboard-list",
                 "href": _href("/pesquisas"), "enabled": bool(launch and launch.has_typeform)},
